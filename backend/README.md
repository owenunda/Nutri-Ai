...
```env
PORT=3000
DB_URL=postgresql://usuario:password@localhost:5432/NutriLife
...
NutriLife implementa las mejores prácticas de seguridad para proteger los datos de los usuarios:
